...
\begin{itemize}
    ...
    \item Compared to full fine-tuning, MR-LoRA reduces trainable parameters by 99\%, memory footprint by ~82\%, and accelerates inference by 4.9$\times$ on average.
\end{itemize}
...
Table~\ref{tab:student-variants} shows the corresponding percentages for student distillation. Per‑task data are available only for LoRA and MR‑LoRA; other variants display only the overall GLUE percentage.
...
AdaLoRA & 12.7\% & -- & 84.0\% & 92.6\% & -- & 93.3\% & 79.3\% & 101.1\% & 77.2\% \\
DoRA & 69.1\% & -- & 85.0\% & 93.8\% & -- & 95.2\% & 79.9\% & 100.6\% & 87.3\% \\
OLoRA & 70.6\% & -- & 84.8\% & 94.2\% & -- & 95.4\% & 80.6\% & 100.8\% & 87.7\% \\
RS‑LoRA & 75.4\% & -- & 84.5\% & 94.1\% & -- & 96.3\% & 81.6\% & 103.1\% & 89.2\% \\
MR‑LoRA‑RS & 81.7\% & -- & 89.1\% & 96.7\% & -- & 97.3\% & 85.5\% & 100.5\% & 91.8\% \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
LoRA & 99.6\%/99.5\% & 74.3\%/82.1\% & 3.4$\times$/4.2$\times$ \\
MR‑LoRA & 99.4\%/99.4\% & 74.1\%/82.0\% & 2.9$\times$/4.9$\times$ \\
AdaLoRA & 99.5\% & -- & -- \\
DoRA & 99.6\% & -- & -- \\
OLoRA & 99.6\% & -- & -- \\
RS‑LoRA & 99.6\% & -- & -- \\
