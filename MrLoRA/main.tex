...
However, the same expressiveness constrains of LoRA arise in the KD scenario, as the single rank matrix in each layer is often too coarse to account for the capacity discrepancies between teacher and student. 
